...
public class FetchDataTaskr extends AsyncTask<String, Void, String>{
    private final FetchDataListenerr listener;
    private String msg;
    
    public FetchDataTaskr(FetchDataListenerr listener) {
    ...
    protected void onPostExecute(String sJson) {
        ...
        try {
            ...
            // create apps list
            List<Applicationr> apps = new ArrayList<Applicationr>();
            
            for(int i=0; i<aJson.length(); i++) {
                JSONObject json = aJson.getJSONObject(i);
                Applicationr app = new Applicationr();
